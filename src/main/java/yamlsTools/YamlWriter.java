...
/**
 * A class that implements the save command, it saves the collection to a file along the specified path.
 *
...
public class YamlWriter {
    ...
    /**
     * Method that saves collection to a file along the specified path.
     *
